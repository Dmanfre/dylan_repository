...
```{r}
#Why are there two playrs from Hawaii in the international players dataset? Their country says USA which is not international.
...
d1_player_counts <- wbb_rosters_22_23 %>% 
...
```{r}
#removing variables that are duplicates or unneeded

rm(list = "md_2021", "md_division_breakdown", "state.center", "md_p5_hometown", "ACS_2021")
```
