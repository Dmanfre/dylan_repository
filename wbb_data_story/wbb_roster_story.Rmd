...
Question: Show me a division breakdown of the players in the dataset that are from Maryland
Answer: There are only 133 D I players from Maryland and 140 who are in D III.
Sentence: 18% of players from Maryland play at P5 institutions. UMD has the most with 3 players but Arkansas is a surprise with 2 players since geographically it's further away. 
...
md_2022 <- get_acs(geography = "place",
              ...
              year = 2022) %>% 
  mutate(year = 2022)
#Why does this only show 12 places?
...
Using 2021 data for Maryland and the 50 states.
...
#Explain that these are 5-year rolling averages in the story
